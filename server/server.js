...
async function startServer() { if (process.env.MONGODB_URI) await mongoose.connect(process.env.MONGODB_URI); app.listen(PORT, () => console.log(`DEYOUNGTECH API running on port ${PORT}`)) }
